  ...
  return (
    <div className={css.container}>
      <div className={css.text}>
        <h1 className={css.title}>Join the League of Superheroes</h1>
        ...
        <div className={css.stats}>
          <div className={css.statItem}>
            ...
            <span className={css.statLabel}>Total Users</span>
          </div>
          <div className={css.statItem}>
            <span className={css.statValue}>500k+</span>
            <span className={css.statLabel}>Art Pictures</span>
          </div>
          <div className={css.statItem}>
            <span className={css.statValue}>1k+</span>
            <span className={css.statLabel}>Heroes</span>
          </div>
        </div>
      </div>
      <div className={css.artCard}>
        ...
        />
        <div className={css.artInfo}>
          <h2 className={css.artTitle}>Superhero Flight</h2>
          <span className={css.artArtist}>
            <svg
